...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FtYWxzYWhuaSIsImEiOiJja2p0c3ljb2YwMm8yMnhvYmNscXZ0ZHdnIn0.5_BKKhBG5Q9o0URDcA2qGQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      ...
      offset: 30,
      closeOnClick: false
    }).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"))).addTo(map).togglePopup(); // Extend the map bound to include current location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:5000/api/v1/users/update-password' : 'http://localhost:5000/api/v1/users/update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(_toConsumableArray(type)[0].toUpperCase() + _toConsumableArray(type).slice(1).join(''), " updated successfully!"));
            }
...
var stripe = Stripe('pk_test_51IAdidG01QBreGydOHkAHcKOqSLeW3XMkPzpKukS1fEQOH7Z6WIUfi4V5vdWKX92FMhnSS5hPtDvb5WUTCon14cs00V0aEMeh1');
...
var booktBtn = document.getElementById('book-tour'); // Delegation
...
if (booktBtn) booktBtn.addEventListener('click', function (e) {
